...
| report | changed files と remaining risk | runbook、done criteria | review-ready でない報告 |
...
返答は Changed Files / Verification / Remaining Risk を含める。
```
...
5. 終了判定
   - verify が通り、Root Cause を説明でき、Remaining Risk を短く言えるなら `done`
