...
- `Restart Packet (Canonical Inputs)`（`restart-protocol.md` の見出し）が current-run の verify と open question を含んでいる
...
- `Restart Packet (Canonical Inputs)` と handoff contract を文章で固定できる
