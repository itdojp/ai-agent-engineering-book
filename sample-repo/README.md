...
本書では `docs/seed-issues.md` の 4 件を貫通ケースとして繰り返し扱います。目的は機能を増やすことではありません。AIエージェントが「答えられる」状態から「仕事を完了できる」状態へ進むとき、どの artifact が必要になるかを追うことです。
...
| `FEATURE-002` | assignee と監査ログの整理が長時間化しやすい | CH01, CH07, CH11, CH12 | long-running task を plan、restart packet、role 分担で扱う |
| `HARNESS-001` | verify と証跡が弱く、変更を安心してレビューできない | CH01, CH09, CH10, CH12 | verification harness と operating model の必要性を理解する |
