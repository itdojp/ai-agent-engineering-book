...
grep -q "meta name=\"book-build-revision\" content=\"$TEST_REVISION\"" "$OUT/en/index.html"
grep -q "meta name=\"book-build-revision\" content=\"$TEST_REVISION\"" "$OUT/en/chapters/ch12/index.html"
