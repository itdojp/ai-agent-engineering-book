...
| WP-01 | `#154` | Open | front matter / glossary / editorial baseline |
...
| WP-06 | `#159` | Open | sample-repo / supporting assets / verify parity |
...
3. まず open な work package issue（現時点では `#154`, `#158`, `#159`）を確認し、その範囲で 1 slice を選ぶ
