...
2. Identify the active track and current work package.
3. Read the latest verify state and open questions, then discard stale assumptions.
4. Narrow the next move to one work package.
